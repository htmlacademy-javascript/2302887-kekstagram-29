...
//Создаём обект эффффекта по умолчанию
const DEFAULT_EFFECT = Effects[0];
//Присваиваем текущему объекту эффекту эффект по умолчанию
...
//Обращаемся к методу on библиотеки noUiSlider и при событии update (перемещение ручки слайдера пользователем)
// вызываем функцию определения позиции ручки слайдера
